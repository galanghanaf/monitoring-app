...
class LogBook extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('superadmin/logbook', $data);
    ...
    public function export_csv()
    {
        ...
        $data['logbook'] = $this->Monitoring_model->getAllLogBook();
        $this->load->view('superadmin/exportLogBook', $data);
    }
    ...
    public function tambahData()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('templatesSuperAdmin/header', $data);
            $this->load->view('templatesSuperAdmin/sidebar');
            $this->load->view('superadmin/formTambahLogBook', $data);
            $this->load->view('templatesSuperAdmin/footer');
        } else {
            $data = [
    ...
    public function updateData($id)
    {
        ...
        $this->load->view('templatesSuperAdmin/header', $data);
        $this->load->view('templatesSuperAdmin/sidebar');
        $this->load->view('superadmin/formUpdateLogBook', $data);
        $this->load->view('templatesSuperAdmin/footer');
    }
    ...
    public function download()
    {
        $data['title'] = "DATA LOG BOOK IT EQUIPMENT";
        $data['logbook'] = $this->Monitoring_model->getAllLogBook();
        $this->load->view('superadmin/downloadLogBook', $data);
    }
}
