...
class AccessPoint extends CI_Controller
{
    ...
    public function tambahData()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->load->view('templatesSuperAdmin/header', $data);
            $this->load->view('templatesSuperAdmin/sidebar');
            $this->load->view('superadmin/formTambahAccessPoint', $data);
            $this->load->view('templatesSuperAdmin/footer');
        } else {
            $data = [
            ...
            redirect('superadmin/accesspoint');
        }
    }
    ...
    public function updateData($id)
    {
        ...
        $this->load->view('templatesSuperAdmin/header', $data);
        $this->load->view('templatesSuperAdmin/sidebar');
        $this->load->view('superadmin/formUpdateAccessPoint', $data);
        $this->load->view('templatesSuperAdmin/footer');
    }
    ...
    public function download()
    {
        $data['title'] = "DATA ACCESS POINT";
        $data['accesspoint'] = $this->Monitoring_model->getAllAccessPoint();
        $this->load->view('superadmin/downloadAccessPoint', $data);
    }
}
