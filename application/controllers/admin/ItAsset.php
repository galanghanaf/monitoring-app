...
class ItAsset extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('admin/itasset', $data);
    ...
    public function tambahData()
    {
        ...
        $this->load->view('templatesAdmin/header', $data);
        $this->load->view('templatesAdmin/sidebar');
        $this->load->view('admin/formTambahItAsset', $data);
        $this->load->view('templatesAdmin/footer');
    }
    ...
    public function updateData($id)
    {
        ...
        $this->load->view('templatesAdmin/header', $data);
        $this->load->view('templatesAdmin/sidebar');
        $this->load->view('admin/formUpdateItAsset', $data);
        $this->load->view('templatesAdmin/footer');
    }
    ...
    public function download()
    {
        ...
        $data['itasset'] = $this->Monitoring_model->getItAsset();
        $this->load->view('admin/downloadItAsset', $data);
    }
}
