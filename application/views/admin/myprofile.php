            ...
            <div class="col-lg">
                <div class="card mb-4">
                    <div class="card-body text-center">
                        <br>
                        <br>
                        <a href="<?= base_url('admin/myprofile/edit') ?>"><img class="img-profile rounded-circle" src="<?= base_url('assets/img/') . $user['image']; ?>" style="width: 140px; height: 140px;"></a>
                        ...
                        <div class="d-flex justify-content-center mb-2">
                            <a class="btn btn-primary mt-2 mb-3" href="<?= base_url('admin/myprofile/edit') ?>">
