...
<div class="container-fluid">
    ...
    <a class="btn btn-sm btn-success mb-3 font-weight-bold" href="<?php echo base_url('admin/otasset/tambahData') ?>">
        <i class="fas fa-plus"></i> Tambah Data</a>
    <a class="btn btn-sm btn-primary mb-3 float-right font-weight-bold" href="<?php echo base_url('admin/otasset/download') ?>">
        ...
        <tbody>
            ...
            foreach ($otasset as $row) : ?>
                <tr>
                    ...
                    <td>
                        <center>
                            <a class="btn btn-sm btn-warning" href="<?php echo base_url('admin/otasset/updateData/' . $row->id) ?>">
                                <i class="fas fa-edit"></i></a>
                        </center>
                    </td>
                    <td>
                        <center>
                            <a onclick="return confirm('Konfirmasi Penghapusan Data')" class="btn btn-sm btn-danger" href="<?php echo base_url('admin/otasset/deleteData/' . $row->id) ?>">
