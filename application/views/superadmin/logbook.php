...
<div class="container-fluid">
    ...
    <a class="btn btn-sm btn-success mb-3 font-weight-bold" href="<?php echo base_url('superadmin/logbook/tambahData') ?>">
        <i class="fas fa-plus"></i> Tambah Data</a>
    <a class="btn btn-sm btn-primary mb-3 float-right font-weight-bold" href="<?php echo base_url('superadmin/logbook/download') ?>">
        ...
        <tbody>
            ...
            foreach ($logbook as $row) : ?>
                <tr>
                    ...
                    <td>
                        <center>
                            <a class="btn btn-sm btn-warning" href="<?php echo base_url('superadmin/logbook/updateData/' . $row->id) ?>">
                    ...
                    <td>
                        <center>
                            ...
                            <a onclick="return confirm('Konfirmasi Penghapusan Data')" class="btn btn-sm btn-danger" href="<?php echo base_url('superadmin/logbook/deleteData/' . $row->id) ?>">
