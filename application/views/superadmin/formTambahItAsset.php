                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <?php echo form_open_multipart('superadmin/itasset/tambahDataAksi') ?>
                            <form method="post" action="<?php echo base_url('superadmin/itasset/tambahDataAksi') ?>" enctype="multipart/form-data">
                                ...
                                <br>
                                <a onclick="return confirm('Apakah anda yakin membatalkan proses ini?')" class="btn btn-danger" href="<?php echo base_url('superadmin/itasset') ?>">
                                    Batal</a>
