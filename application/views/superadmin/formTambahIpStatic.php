                ...
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <form method="post" action="<?= base_url('superadmin/ipstatic/tambahData'); ?>">
                                ...
                                <a onclick="return confirm('Apakah anda yakin membatalkan proses ini?')" class="btn btn-danger" href="<?php echo base_url('superadmin/ipstatic') ?>">
                                    Batal</a>
