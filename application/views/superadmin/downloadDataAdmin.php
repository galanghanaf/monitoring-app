            ...
            <div id="content">
                <div class="container-fluid">
                    ...
                    <div class="card">
                        <center>
                            <br>
                            <a href="<?php echo base_url('superadmin/dataadmin') ?>" style="float:left" class="previous btn button3 btn-primary"><i class="fas fa-arrow-left"></i></a>
                    ...
                    <br><br>
                    <center>
                        <table class=" table-hover table table-bordered w-100 float-left" id="downloadDataAdmin">
                            <thead>
                                <tr>
