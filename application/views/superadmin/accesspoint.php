...
<div class="container-fluid ">
    ...
    <a class="btn btn-sm btn-success mb-3 font-weight-bold" href="<?php echo base_url('superadmin/accesspoint/tambahData') ?>">
        <i class="fas fa-plus"></i> Tambah Data</a>
    <a class="btn btn-sm btn-primary mb-3 float-right font-weight-bold" href="<?php echo base_url('superadmin/accesspoint/download') ?>">
        <i class="fas fa-download"></i> Download Data</a>
    <?php echo $this->session->flashdata('message') ?>

    <table class=" table-hover table table-bordered w-100" id="dataTablesAccessPoint">
        <thead>
            <tr>
                ...
                <th class="no-sort align-middle text-center bg-primary text-white" rowspan="2">PCB Serial Number</th>
                <th class="no-sort align-middle text-center bg-primary text-white" rowspan="2">Assembly Serial Number</th>
        ...
        <tbody>
            ...
            foreach ($accesspoint as $row) : ?>
                <tr>
                    ...
                    <td class="align-middle text-center"><?php echo $row->asset_description; ?></td>
                    <td class="align-middle text-center"><?php echo $row->hostname; ?></td>
                    <td class="align-middle text-center"><?php echo $row->model; ?></td>
                    <td class="align-middle text-center"><?php echo $row->pcb; ?></td>
                    <td class="align-middle text-center"><?php echo $row->assembly; ?></td>
                    <td class="align-middle text-center"><?php echo $row->ip_address; ?></td>
                    <td class="align-middle text-center"><?php echo $row->mac_address; ?></td>
                    <td class="align-middle text-center"><?php echo $row->switch; ?></td>
                    <td class="align-middle text-center"><?php echo $row->port; ?></td>
                    <td>
                        <center>
                            <a class="btn btn-sm btn-warning" href="<?php echo base_url('superadmin/accesspoint/updateData/' . $row->id) ?>">
                                <i class="fas fa-edit"></i></a>
                        </center>
                    </td>
                    <td>
                        <center>
                            <a onclick="return confirm('Konfirmasi Penghapusan Data')" class="btn btn-sm btn-danger" href="<?php echo base_url('superadmin/accesspoint/deleteData/' . $row->id) ?>">
